...
If strBrowserExe <> "" Then
    ...
    objShortcut.Arguments = "--app=""" & strFileUri & """ --disable-frame-rate-limit --enable-smooth-scrolling --enable-gpu-rasterization --enable-zero-copy --ignore-gpu-blocklist --disable-features=UseEcoQoSForBackgroundProcess"
