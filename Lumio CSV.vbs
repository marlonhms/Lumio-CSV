...
If strBrowserExe <> "" Then
    ...
    objShell.Run """" & strBrowserExe & """ --app=""" & strFileUri & """ --disable-frame-rate-limit --enable-smooth-scrolling --enable-gpu-rasterization --enable-zero-copy --ignore-gpu-blocklist --disable-features=UseEcoQoSForBackgroundProcess", 1, False
Else
